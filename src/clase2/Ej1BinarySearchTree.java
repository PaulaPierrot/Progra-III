...
public class Ej1BinarySearchTree {
    ...
    public static int getHeight(int x, TreeNode root) {
        //precondición: es necesario que x se encuentre en el arbol.
        if(root==null) {
            return 0;
        }
            ...
            return (1+getHeight(x,root.left));
        }
        else {
            return (1+getHeight(x, root.right));
        }
        // Costo: T(n)= T(n-1) + O(1) --> O(n^2)
